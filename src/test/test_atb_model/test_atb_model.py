...
dir = '/home/dword/Desktop/SmartReader/src/atb_model/'
...
class test_atb_model(unittest.TestCase):
    ...
    def test_simple_get_audio_list(self):
        mdl = Model()
        dir = os.path.join(os.getcwd(), 'test_files', 'simple.atb')
        mdl.load(dir)
    ...
    def test_hard_names_get_audio_list(self):
        mdl = Model()
        dir = os.path.join(os.getcwd(), 'test_files', 'hard_names.atb')
        mdl.load(dir)
    ...
    def test_book2_get_word_list(self):
        mdl = Model()
        dir = os.path.join(os.getcwd(), 'test_files', 'book2_data.atb')
        mdl.load(dir)
    ...
    def test_book3_get_word_list(self):
        mdl = Model()
        dir = os.path.join(os.getcwd(), 'test_files', 'book3_data.atb')
        mdl.load(dir)
    ...
    def test_book4_get_word_list(self):
        mdl = Model()
        dir = os.path.join(os.getcwd(), 'test_files', 'book4_data.atb')
        mdl.load(dir)
